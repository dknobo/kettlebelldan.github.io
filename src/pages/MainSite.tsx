  ...
  return (
    <div className="max-w-[680px] mx-auto px-6 py-12 text-[#e5e5e5]">
      ...
      >
        ...
        {/* X Employee */}
        <motion.div variants={fadeUp} className="mb-8 group">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-2xl transition-transform group-hover:scale-150">𝕏</span>
            <div className="font-semibold text-2xl text-white tracking-[-0.5px]">X Employee</div>
          </div>
          <p className="text-[15px] text-[#b3b3b3] pl-9">
        ...
        <motion.div variants={fadeUp} className="mb-8 group">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-2xl transition-transform group-hover:scale-150">🏋️</span>
        ...
        <motion.div variants={fadeUp} className="mb-8 group">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-2xl transition-transform group-hover:scale-150">👔</span>
